...
public class AwsS3Controller {
    ...
    public ResponseEntity<ImageInfoResponse> upload(@RequestPart("file") MultipartFile multipartFile) {
        ...
        Long postFileId = postImageService.createPostFile(multipartFile, imageInfoDto);
        return ResponseEntity.ok(ImageInfoResponse.of(postFileId, imageInfoDto.getUrl()));
    }
}
